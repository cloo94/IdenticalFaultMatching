...
int main (int argc, char * argv[]) {
  ...
  */
  ...
  //char *fault_array2[10000][3];
	...
	data1 = strsep(&line2," inputs");
	data1 = strsep(&line2,"# ");
	totalinputs = atoi(data1);
	printf("Auto input count: %d\n",totalinputs);
      }

      if (strstr(line, " output") != NULL) {
	data1 = strsep(&line2," outputs");
	data1 = strsep(&line2,"# ");
	totaloutputs = atoi(data1);
	printf("Auto output count: %d\n",totaloutputs);
      }

      if (strstr(line, " flip-flop") != NULL) {
	data1 = strsep(&line2," D-type");
	data1 = strsep(&line2,"# ");
	totalflipflops = atoi(data1);
	...
	data1 = strsep(&line2," ");
	data1 = strsep(&line2," ");
	totalbuffs = atoi(data1);
	printf("Auto buff count: %d\n",totalbuffs);
	
	data1 = strsep(&line2, "+");
	data1 = strsep(&line2," ");
	data1 = strsep(&line2," ");
	totalnots = atoi(data1);
	printf("Auto not count: %d\n",totalnots);

        data1 = strsep(&line2, "+");
	data1 = strsep(&line2," ");
	data1 = strsep(&line2," ");
	totalands = atoi(data1);
	printf("Auto and count: %d\n",totalands);
	
        data1 = strsep(&line2, "+");
	data1 = strsep(&line2," ");
	data1 = strsep(&line2," ");
	totalnands = atoi(data1);
	...
	data1 = strsep(&line2," ");
	data1 = strsep(&line2," ");
	totalnors = atoi(data1);
	printf("Auto nor count: %d\n",totalnors);
	
	data1 = strsep(&line2, "+");
	data1 = strsep(&line2," ");
	data1 = strsep(&line2," ");
	totalxors = atoi(data1);
	printf("Auto xor count: %d\n",totalxors);
	
	data1 = strsep(&line2, "+");
	data1 = strsep(&line2," ");
	data1 = strsep(&line2," ");
	totalnxors = atoi(data1);
	printf("Auto xor count: %d\n",totalnxors);
