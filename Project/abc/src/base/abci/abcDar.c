...
//        ABC_FREE( pMiter->pModel );
    ...
    {
        Abc_NtkDelete( pMiter );
        Abc_Print( 1, "These networks are equivalent after structural hashing. 2\n" );

        printf("These networks are equivalent after structural hashing. 2\n");

        FILE *fp;
        fp = fopen("testOuts.txt","w+");
        fprintf(fp,"These networks are equivalent after structural hashing. 2\n");
        fclose(fp);
...
//        Abc_NtkVerifyReportErrorSeq( pNtk1, pNtk2, pMiter->pModel, pSecPar->nFramesMax );
    ...
    {
        Abc_NtkDelete( pMiter );
        Abc_Print( 1, "These networks are equivalent after structural hashing. 3\n" );

        printf("These networks are equivalent after structural hashing. 3\n");

        FILE *fp;
        fp = fopen("testOuts.txt","w+");
        fprintf(fp,"These networks are equivalent after structural hashing. 3\n");
        fclose(fp);
...
/*
    ...
    {
        Abc_NtkDelete( pMiter );
        Abc_Print( 1, "These networks are equivalent after structural hashing. 4\n" );
        return 1;
    }
*/
    // derive the AIG manager
