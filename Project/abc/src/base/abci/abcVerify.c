...
void Abc_NtkCecSat( Abc_Ntk_t * pNtk1, Abc_Ntk_t * pNtk2, int nConfLimit, int nInsLimit )
{
    ...
    {
        Abc_NtkDelete( pMiter );
        printf( "These networks are equivalent after structural hashing. 6\n" );
        FILE *fp;
        fp = fopen("testOuts.txt","w+");
        fprintf(fp,"These networks are equivalent after structural hashing.. 6\n");
        fclose(fp);
        return;
    }
...
//    Fraig_Man_t * pMan;
    ...
    if ( RetValue == 1 )
    {
        printf( "These networks are equivalent after structural hashing.\n");
        FILE *fp;
        fp = fopen("testOuts.txt","w+");
        fprintf(fp,"These networks are equivalent after structural hashing.\n");
        fclose(fp);
        Abc_NtkDelete( pMiter );
        return;
    }
...
void Abc_NtkCecFraigPart( Abc_Ntk_t * pNtk1, Abc_Ntk_t * pNtk2, int nSeconds, int nPartSize, int fVerbose )
{
    ...
    if ( RetValue == 1 )
    {
        printf( "These networks are equivalent after structural hashing.  8\n" );
        FILE *fp;
        fp = fopen("testOuts.txt","w+");
        fprintf(fp,"These networks are equivalent after structural hashing. 8\n");
        fclose(fp);
        Abc_NtkDelete( pMiter );
        return;
    }
...
void Abc_NtkCecFraigPartAuto( Abc_Ntk_t * pNtk1, Abc_Ntk_t * pNtk2, int nSeconds, int fVerbose )
{
    ...
    if ( RetValue == 1 )
    {
        printf( "These networks are equivalent after structural hashing. 9\n" );
        FILE *fp;
        fp = fopen("testOuts.txt","w+");
        fprintf(fp,"These networks are equivalent after structural hashing. 9\n");
        fclose(fp);
        Abc_NtkDelete( pMiter );
        return;
    }
...
void Abc_NtkSecSat( Abc_Ntk_t * pNtk1, Abc_Ntk_t * pNtk2, int nConfLimit, int nInsLimit, int nFrames )
{
    ...
    {
        Abc_NtkDelete( pMiter );
        printf( "These networks are equivalent after structural hashing. 10\n" );
        FILE *fp;
        fp = fopen("testOuts.txt","w+");
        fprintf(fp,"These networks are equivalent after structural hashing. 10\n");
        fclose(fp);
        return;
    }
...
int Abc_NtkSecFraig( Abc_Ntk_t * pNtk1, Abc_Ntk_t * pNtk2, int nSeconds, int nFrames, int fVerbose )
{
    ...
    {
        Abc_NtkDelete( pMiter );
        printf( "These networks are equivalent after structural hashing. 11\n" );
        FILE *fp;
        fp = fopen("testOuts.txt","w+");
        fprintf(fp,"These networks are equivalent after structural hashing. 11\n");
        fclose(fp);
        return 1;
    }
